    ...
    public class LuaProfilerTreeView : TreeView
    {
        ...
        private static MultiColumnHeader CreateDefaultMultiColumnHeaderState(float treeViewWidth)
        {
            var columns = new[]
            {
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("totalLuaGC"),
                    contextMenuText = "totalLuaGC",
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("selfLuaGC"),
                    contextMenuText = "selfLuaGC",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 70,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("totalMonoGC"),
                    contextMenuText = "totalMonoGC",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 100,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("selfMonoGC"),
                    contextMenuText = "selfMonoGC",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 100,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("curTime"),
                    contextMenuText = "curTime",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 100,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("selfTime"),
                    contextMenuText = "selfTime",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 100,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = new GUIContent("avgTime"),
                    contextMenuText = "avgTime",
                    headerTextAlignment = TextAlignment.Center,
                    sortedAscending = false,
                    sortingArrowAlignment = TextAlignment.Right,
                    width = 100,
